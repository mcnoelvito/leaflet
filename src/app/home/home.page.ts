...
export class HomePage {
  ...
  ionViewDidEnter() {
    ...
    const locations = [
      ...
      { lat: -7.791725695799328, lng: 110.366616342279, title: 'Gedung DPRD DIY',description: 'Merupakan sebuah kompleks bangunan DPRD Provinsi Daerah Istimewa Yogyakarta yang dikenal sebagai Loge Mataram.' },
